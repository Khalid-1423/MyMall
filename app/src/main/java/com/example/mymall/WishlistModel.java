...
public class WishlistModel {
    ...
    public WishlistModel(int productImage, String productTitle, int freeCoupens, String rating, int totalRatings, String prodcutPrice, String cuttedPrice, String paymentMethod) {
