    ...
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType)
        {
            case ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                layoutParams.setMargins(setDp(16,parent.getContext()), // left
                        setDp(16,parent.getContext()), //top
                        setDp(16,parent.getContext()), //right
                        setDp(8,parent.getContext())); //bottom
            ...
            case ProductSpecificationModel.SPECIFICATION_BODY:
                ...
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_specification_item_layoout,parent,false);
